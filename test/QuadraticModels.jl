...
using PowerModels; PowerModels.silence()
...
function exa_ac_power_model(backend, data)
...
@testset "Taylor of ACOPF via QuadraticModels.jl " begin
    backend = CPU()
    data = parse_ac_power_data("pglib_opf_case14_ieee.m", backend)
