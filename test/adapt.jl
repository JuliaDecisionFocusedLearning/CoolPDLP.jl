...
@test sad isa SaddlePointProblem{Float64,Vector{Float64},SparseMatrixCSC{Float64,Int64}}
@test sad_32 isa SaddlePointProblem{Float32,Vector{Float32},SparseMatrixCSC{Float32,Int32}}
@test sad_device isa SaddlePointProblem{
    Float32,Vector{Float32},GPUSparseMatrixCSR{Float32,Int32,Vector{Float32},Vector{Int32}}
}
