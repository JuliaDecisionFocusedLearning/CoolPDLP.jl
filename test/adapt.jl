...
milp_device = to_device(milp)
milp_jl = adapt(JLBackend(), milp_device)

sad = SaddlePointProblem(milp)
sad_device = SaddlePointProblem(milp_device)
sad_jl = SaddlePointProblem(milp_jl)
...
@testset "Device" begin
    ...
    @test change_floating_type(Float32, milp_device) isa MILP{
        ...
        DeviceSparseMatrixCSR{
            Float32, Int64,
            Vector{Int64}, Vector{Int64}, Vector{Float32},
        },
    }
    @test change_integer_type(Int32, milp_device) isa MILP{
        ...
        DeviceSparseMatrixCSR{
            Float64, Int32,
            Vector{Int32}, Vector{Int32}, Vector{Float64},
        },
    }
end
...
@testset "JL" begin
    ...
    @test milp_jl isa MILP{
        ...
        DeviceSparseMatrixCSR{
            Float64, Int64,
            JLVector{Int64}, JLVector{Int64}, JLVector{Float64},
        },
    }
end
